        ...
        switch(sel) {
            case 't' :
                ...
                for(int i=0; i<tempStr.length(); i++) {
                    ...
                    if(!found && (tempStr[i] == '(' || tempStr[i]=='[' || tempStr[i]=='{' || tempStr[i]=='<'
                                  ||tempStr[i] == ')' || tempStr[i]==']'||tempStr[i]=='}'||tempStr[i]=='>')) {
                        found = true;
                    }
                }
                if(found == false) {
                    cout << "No Parenthesis in String" << endl;
                    break;
                }
                else if(tempStr.length() > 50 ) {
                    cout << "Can not enter String with more than 50 characters" << endl;
                    break;
                }
